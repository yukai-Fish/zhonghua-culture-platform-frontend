    ...
    <div className="page culture-map-page page-fade">
      ...
      {activeTheme.id === 'buddhism' && !isMobileViewport && (
        <section className="flat-buddhist-content" aria-label="佛教文化平铺内容">
          <div className="auxiliary-video-preloaders" aria-hidden="true">
            <video src={cultureAssets.scriptureVideo} preload="auto" muted playsInline />
            <video src={cultureAssets.blessingVideo} preload="auto" muted playsInline />
          </div>
